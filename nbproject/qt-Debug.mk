#############################################################################
# Makefile for building: NMEA
# Generated by qmake (2.01a) (Qt 4.8.4) on: ?? 30. ??? 09:57:53 2013
...
LIBS        =        -L'c:/Qt/4.8.4/lib' -lmingw32 -lqtmaind build/Debug/MinGW_Qt-Windows/NMEA_resource_res.o -lQtGuid4 -lQtCored4 
QMAKE         = c:/Qt/4.8.4/bin/qmake.exe
IDC           = c:/Qt/4.8.4/bin/idc.exe
IDL           = midl
ZIP           = zip -r -9
DEF_FILE      = 
RES_FILE      = build/Debug/MinGW_Qt-Windows/NMEA_resource_res.o
COPY          = cp
SED           = 
COPY_FILE     = $(COPY)
COPY_DIR      = cp -r
...
SOURCES       = NMEA.cpp \
		main.cpp moc_NMEA.cpp
OBJECTS       = build/Debug/MinGW_Qt-Windows/NMEA.o \
		build/Debug/MinGW_Qt-Windows/main.o \
		build/Debug/MinGW_Qt-Windows/moc_NMEA.o
DIST          = 
QMAKE_TARGET  = NMEA
DESTDIR        = dist/Debug/MinGW_Qt-Windows/ #avoid trailing-slash linebreak
TARGET         = NMEA.exe
DESTDIR_TARGET = dist/Debug/MinGW_Qt-Windows/NMEA.exe
...
$(DESTDIR_TARGET): ui_NMEA.h $(OBJECTS) build/Debug/MinGW_Qt-Windows/NMEA_resource_res.o
	$(LINK) $(LFLAGS) -o $(DESTDIR_TARGET) $(OBJECTS)  $(LIBS)

build/Debug/MinGW_Qt-Windows/NMEA_resource_res.o: NMEA_resource.rc
	windres -i NMEA_resource.rc -o build/Debug/MinGW_Qt-Windows/NMEA_resource_res.o --include-dir=. $(DEFINES)
...
compiler_moc_header_make_all: moc_NMEA.cpp
compiler_moc_header_clean:
	-$(DEL_FILE) moc_NMEA.cpp
moc_NMEA.cpp: ui_NMEA.h \
		NMEA.h
	C:/Qt/4.8.4/bin/moc.exe $(DEFINES) $(INCPATH) -D__GNUC__ -DWIN32 NMEA.h -o moc_NMEA.cpp
...
compiler_uic_make_all: ui_NMEA.h
compiler_uic_clean:
	-$(DEL_FILE) ui_NMEA.h
ui_NMEA.h: NMEA.ui
	c:/Qt/4.8.4/bin/uic.exe NMEA.ui -o ui_NMEA.h
...
build/Debug/MinGW_Qt-Windows/NMEA.o: NMEA.cpp NMEA.h \
		ui_NMEA.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o build/Debug/MinGW_Qt-Windows/NMEA.o NMEA.cpp

build/Debug/MinGW_Qt-Windows/main.o: main.cpp NMEA.h \
		ui_NMEA.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o build/Debug/MinGW_Qt-Windows/main.o main.cpp

build/Debug/MinGW_Qt-Windows/moc_NMEA.o: moc_NMEA.cpp 
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o build/Debug/MinGW_Qt-Windows/moc_NMEA.o moc_NMEA.cpp
