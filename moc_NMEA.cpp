...
**
** Created: Tue 30. Apr 09:56:14 2013
...
static const char qt_meta_stringdata_NMEA[] = {
    "NMEA\0"
};
...
const QMetaObjectExtraData NMEA::staticMetaObjectExtraData = {
    0,  qt_static_metacall 
};

const QMetaObject NMEA::staticMetaObject = {
    { &QDialog::staticMetaObject, qt_meta_stringdata_NMEA,
      qt_meta_data_NMEA, &staticMetaObjectExtraData }
};

#ifdef Q_NO_DATA_RELOCATION
const QMetaObject &NMEA::getStaticMetaObject() { return staticMetaObject; }
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_NMEA))
